...
@export var rotationRandomness : float = PI/15.0
...
func _ready() -> void:
	...
	belt_mat.set_shader_parameter("scroll_speed", speed_uv_per_sec*conveyor_speed)
...
func _on_timer_timeout() -> void:
	...
	corpse.visuals.rotation.y = randf_range(-rotationRandomness, rotationRandomness) + (randi_range(0,1)*PI)
